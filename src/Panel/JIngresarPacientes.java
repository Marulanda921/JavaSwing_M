...
public class JIngresarPacientes extends JPanel {
	...
	public JIngresarPacientes(String doctorID) {
		...
		panelDerecha.setLayout(new GridLayout(0, 1, 0, 0));
				...
				JButton btnHistorialPacientes = new JButton("Listar Historial Clinico");
    ...
    scrollPane.setPreferredSize(new Dimension(400, 300)); // Establece el tamaño preferido del JScrollPane
